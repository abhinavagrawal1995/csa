...
<div class="row">
	<div class="12u">
		<h3>Oracle Fusion Customer Relationship Management</h3>
			<p>
				Oracle Fusion Customer Relationship Management (CRM) is a 100 percent open, standards­based set of integrated CRM modules that improves the way sales professionals work. Unlike traditional CRM systems that focus only on transaction processing, with collaboration, reporting, analysis, and exception management as an afterthought, Oracle Fusion CRM is designed to deliver unprecedented business insight into sales performance management. <a href="http://www.oracle.com/us/solutions/cloud/sales-marketing/overview/index.html?ssSourceSiteId=ocomin">Read More.</a>
			</p>
	</div>
</div>
<br>
